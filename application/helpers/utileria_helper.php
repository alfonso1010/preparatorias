...
if ( ! function_exists('numeroColumnas'))
{
    function numeroColumnas($indiceHoja)
    {   
        $numeroMayorDeColumna = 0;
        switch ($indiceHoja) {
            case 0:
                $numeroMayorDeColumna = 3;
                break;
            case 1:
                $numeroMayorDeColumna = 8;
                break;
            case 2:
                $numeroMayorDeColumna = 3;
                break;
            case 3:
                $numeroMayorDeColumna = 6;
                break;
            case 4:
                $numeroMayorDeColumna = 9;
                break;
            case 5:
                $numeroMayorDeColumna = 3;
                break;
            case 6:
                $numeroMayorDeColumna = 4;
                break;
            case 7:
                $numeroMayorDeColumna = 11;
                break;
            case 8:
                $numeroMayorDeColumna = 8;
                break;
        ...
        return $numeroMayorDeColumna;
       
    }   
}


function searchMultiArray($val, $array,$search) {
  foreach ($array as $element) {
    if ($element[$search] == $val) {
      return 0;
    }
  }
  return 1;
